...
public class StrengthTrainingDumbellsTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final SidedInvWrapper handler = new SidedInvWrapper(this, null);

	public StrengthTrainingDumbellsTileEntity(BlockPos pos, BlockState state) {
		super(SlsbModBlockEntities.STRENGTH_TRAINING_DUMBELLS.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(StrengthTrainingDumbellsBlock.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<StrengthTrainingDumbellsTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<StrengthTrainingDumbellsTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("strength_training_dumbells");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Dumbell Rack");
	}
