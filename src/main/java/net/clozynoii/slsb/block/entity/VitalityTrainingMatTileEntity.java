...
public class VitalityTrainingMatTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final SidedInvWrapper handler = new SidedInvWrapper(this, null);

	public VitalityTrainingMatTileEntity(BlockPos pos, BlockState state) {
		super(SlsbModBlockEntities.VITALITY_TRAINING_MAT.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(VitalityTrainingMatBlock.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<VitalityTrainingMatTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<VitalityTrainingMatTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("vitality_training_mat");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Training Mat");
	}
