...
public class AgilityTreadmillTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final SidedInvWrapper handler = new SidedInvWrapper(this, null);

	public AgilityTreadmillTileEntity(BlockPos pos, BlockState state) {
		super(SlsbModBlockEntities.AGILITY_TREADMILL.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(AgilityTreadmillBlock.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<AgilityTreadmillTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<AgilityTreadmillTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("agility_treadmill");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Treadmill");
	}
