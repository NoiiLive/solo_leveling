...
public class AwakeningOrbTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final SidedInvWrapper handler = new SidedInvWrapper(this, null);

	public AwakeningOrbTileEntity(BlockPos pos, BlockState state) {
		super(SlsbModBlockEntities.AWAKENING_ORB.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(AwakeningOrbBlock.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<AwakeningOrbTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<AwakeningOrbTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("awakening_orb");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Awakening Orb");
	}
