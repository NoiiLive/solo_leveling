...
import net.clozynoii.slsb.procedures.AbilityKey3Procedure;
import net.clozynoii.slsb.SlsbMod;

@EventBusSubscriber(bus = EventBusSubscriber.Bus.MOD)
public record Ability3Message(int eventType, int pressedms) implements CustomPacketPayload {
	public static final Type<Ability3Message> TYPE = new Type<>(ResourceLocation.fromNamespaceAndPath(SlsbMod.MODID, "key_ability_3"));
	...
	public static void pressAction(Player entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			AbilityKey3Procedure.execute(world, x, y, z, entity);
		}
		if (type == 1) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		SlsbMod.addNetworkMessage(Ability3Message.TYPE, Ability3Message.STREAM_CODEC, Ability3Message::handleData);
	}
}
