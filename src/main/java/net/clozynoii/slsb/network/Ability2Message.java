...
import net.clozynoii.slsb.procedures.AbilityKey2Procedure;
import net.clozynoii.slsb.SlsbMod;

@EventBusSubscriber(bus = EventBusSubscriber.Bus.MOD)
public record Ability2Message(int eventType, int pressedms) implements CustomPacketPayload {
	public static final Type<Ability2Message> TYPE = new Type<>(ResourceLocation.fromNamespaceAndPath(SlsbMod.MODID, "key_ability_2"));
	...
	public static void pressAction(Player entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			AbilityKey2Procedure.execute(world, x, y, z, entity);
		}
		if (type == 1) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		SlsbMod.addNetworkMessage(Ability2Message.TYPE, Ability2Message.STREAM_CODEC, Ability2Message::handleData);
	}
}
