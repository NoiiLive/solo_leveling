...
import net.clozynoii.slsb.procedures.ShadowIgrisTickProcedure;
...
public class IgrisShadowEntity extends TamableAnimal implements GeoEntity {
	...
	protected void defineSynchedData(SynchedEntityData.Builder builder) {
		...
		builder.define(TEXTURE, "shadow_igris");
	}
	...
	public void baseTick() {
		super.baseTick();
		ShadowIgrisTickProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ());
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		IgrisShadowEntity retval = SlsbModEntities.IGRIS_SHADOW.get().create(serverWorld);
