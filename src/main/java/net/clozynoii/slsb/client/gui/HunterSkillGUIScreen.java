...
public class HunterSkillGUIScreen extends AbstractContainerScreen<HunterSkillGUIMenu> {
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int gx, int gy) {
		...
		guiGraphics.blit(ResourceLocation.parse("slsb:textures/screens/tab_bottom_selected.png"), this.leftPos + -63, this.topPos + 77, 0, 0, 26, 32, 26, 32);
	...
	public void init() {
		...
		imagebutton_tab_bottom = new ImageButton(this.leftPos + -38, this.topPos + 78, 26, 32, new WidgetSprites(ResourceLocation.parse("slsb:textures/screens/tab_bottom.png"), ResourceLocation.parse("slsb:textures/screens/tab_bottom.png")), e -> {
			if (true) {
				PacketDistributor.sendToServer(new HunterSkillGUIButtonMessage(16, x, y, z));
				HunterSkillGUIButtonMessage.handleButtonAction(entity, 16, x, y, z);
			}
		}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int x, int y, float partialTicks) {
