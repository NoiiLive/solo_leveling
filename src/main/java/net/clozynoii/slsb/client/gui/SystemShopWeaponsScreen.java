...
public class SystemShopWeaponsScreen extends AbstractContainerScreen<SystemShopWeaponsMenu> {
	...
	public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
		...
		if (mouseX > leftPos + -69 && mouseX < leftPos + -51 && mouseY > topPos + -37 && mouseY < topPos + -19)
			guiGraphics.renderTooltip(font, Component.translatable("gui.slsb.system_shop_weapons.tooltip_erank_weapon"), mouseX, mouseY);
		if (mouseX > leftPos + -69 && mouseX < leftPos + -51 && mouseY > topPos + -14 && mouseY < topPos + 4)
			guiGraphics.renderTooltip(font, Component.translatable("gui.slsb.system_shop_weapons.tooltip_drank_weapon"), mouseX, mouseY);
		if (mouseX > leftPos + -69 && mouseX < leftPos + -51 && mouseY > topPos + 9 && mouseY < topPos + 27)
			guiGraphics.renderTooltip(font, Component.translatable("gui.slsb.system_shop_weapons.tooltip_crank_weapon"), mouseX, mouseY);
		if (mouseX > leftPos + 3 && mouseX < leftPos + 21 && mouseY > topPos + -37 && mouseY < topPos + -19)
			guiGraphics.renderTooltip(font, Component.translatable("gui.slsb.system_shop_weapons.tooltip_brank_weapon"), mouseX, mouseY);
		if (mouseX > leftPos + 3 && mouseX < leftPos + 21 && mouseY > topPos + -14 && mouseY < topPos + 4)
			guiGraphics.renderTooltip(font, Component.translatable("gui.slsb.system_shop_weapons.tooltip_arank_weapon"), mouseX, mouseY);
		if (mouseX > leftPos + 3 && mouseX < leftPos + 21 && mouseY > topPos + 9 && mouseY < topPos + 27)
			guiGraphics.renderTooltip(font, Component.translatable("gui.slsb.system_shop_weapons.tooltip_srank_weapon"), mouseX, mouseY);
		if (mouseX > leftPos + -60 && mouseX < leftPos + -42 && mouseY > topPos + 86 && mouseY < topPos + 104)
			guiGraphics.renderTooltip(font, Component.translatable("gui.slsb.system_shop_weapons.tooltip_fighter"), mouseX, mouseY);
		if (mouseX > leftPos + -40 && mouseX < leftPos + -22 && mouseY > topPos + 86 && mouseY < topPos + 104)
			guiGraphics.renderTooltip(font, Component.translatable("gui.slsb.system_shop_weapons.tooltip_tanker"), mouseX, mouseY);
		if (mouseX > leftPos + -20 && mouseX < leftPos + -2 && mouseY > topPos + 86 && mouseY < topPos + 104)
			guiGraphics.renderTooltip(font, Component.translatable("gui.slsb.system_shop_weapons.tooltip_assassin"), mouseX, mouseY);
		if (mouseX > leftPos + 0 && mouseX < leftPos + 18 && mouseY > topPos + 86 && mouseY < topPos + 104)
			guiGraphics.renderTooltip(font, Component.translatable("gui.slsb.system_shop_weapons.tooltip_ranger"), mouseX, mouseY);
		if (mouseX > leftPos + 20 && mouseX < leftPos + 38 && mouseY > topPos + 86 && mouseY < topPos + 104)
			guiGraphics.renderTooltip(font, Component.translatable("gui.slsb.system_shop_weapons.tooltip_mage"), mouseX, mouseY);
		if (mouseX > leftPos + 40 && mouseX < leftPos + 58 && mouseY > topPos + 86 && mouseY < topPos + 104)
			guiGraphics.renderTooltip(font, Component.translatable("gui.slsb.system_shop_weapons.tooltip_healer"), mouseX, mouseY);
	}
	...
	public void init() {
		...
		imagebutton_icon_class_fighter = new ImageButton(this.leftPos + -59, this.topPos + 87, 16, 16,
				new WidgetSprites(ResourceLocation.parse("slsb:textures/screens/icon_class_fighter.png"), ResourceLocation.parse("slsb:textures/screens/icon_class_fighter.png")), e -> {
					if (true) {
						PacketDistributor.sendToServer(new SystemShopWeaponsButtonMessage(10, x, y, z));
						SystemShopWeaponsButtonMessage.handleButtonAction(entity, 10, x, y, z);
					}
				}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int x, int y, float partialTicks) {
		...
		imagebutton_icon_class_tanker = new ImageButton(this.leftPos + -39, this.topPos + 87, 16, 16,
				new WidgetSprites(ResourceLocation.parse("slsb:textures/screens/icon_class_tanker.png"), ResourceLocation.parse("slsb:textures/screens/icon_class_tanker.png")), e -> {
					if (true) {
						PacketDistributor.sendToServer(new SystemShopWeaponsButtonMessage(11, x, y, z));
						SystemShopWeaponsButtonMessage.handleButtonAction(entity, 11, x, y, z);
					}
				}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int x, int y, float partialTicks) {
		...
		imagebutton_icon_class_assassin = new ImageButton(this.leftPos + -19, this.topPos + 87, 16, 16,
				new WidgetSprites(ResourceLocation.parse("slsb:textures/screens/icon_class_assassin.png"), ResourceLocation.parse("slsb:textures/screens/icon_class_assassin.png")), e -> {
					if (true) {
						PacketDistributor.sendToServer(new SystemShopWeaponsButtonMessage(12, x, y, z));
						SystemShopWeaponsButtonMessage.handleButtonAction(entity, 12, x, y, z);
					}
				}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int x, int y, float partialTicks) {
		...
		imagebutton_icon_class_ranger = new ImageButton(this.leftPos + 1, this.topPos + 87, 16, 16,
				new WidgetSprites(ResourceLocation.parse("slsb:textures/screens/icon_class_ranger.png"), ResourceLocation.parse("slsb:textures/screens/icon_class_ranger.png")), e -> {
					if (true) {
						PacketDistributor.sendToServer(new SystemShopWeaponsButtonMessage(13, x, y, z));
						SystemShopWeaponsButtonMessage.handleButtonAction(entity, 13, x, y, z);
					}
				}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int x, int y, float partialTicks) {
		...
		imagebutton_icon_class_mage = new ImageButton(this.leftPos + 21, this.topPos + 87, 16, 16,
				new WidgetSprites(ResourceLocation.parse("slsb:textures/screens/icon_class_mage.png"), ResourceLocation.parse("slsb:textures/screens/icon_class_mage.png")), e -> {
					if (true) {
						PacketDistributor.sendToServer(new SystemShopWeaponsButtonMessage(14, x, y, z));
						SystemShopWeaponsButtonMessage.handleButtonAction(entity, 14, x, y, z);
					}
				}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int x, int y, float partialTicks) {
		...
		imagebutton_icon_class_healer = new ImageButton(this.leftPos + 41, this.topPos + 87, 16, 16,
				new WidgetSprites(ResourceLocation.parse("slsb:textures/screens/icon_class_healer.png"), ResourceLocation.parse("slsb:textures/screens/icon_class_healer.png")), e -> {
					if (true) {
						PacketDistributor.sendToServer(new SystemShopWeaponsButtonMessage(15, x, y, z));
						SystemShopWeaponsButtonMessage.handleButtonAction(entity, 15, x, y, z);
					}
				}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int x, int y, float partialTicks) {
