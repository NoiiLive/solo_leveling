...
import net.clozynoii.slsb.network.SystemShopArmorButtonMessage;

import java.util.HashMap;

import com.mojang.blaze3d.systems.RenderSystem;

public class SystemShopArmorScreen extends AbstractContainerScreen<SystemShopArmorMenu> {
	private final static HashMap<String, Object> guistate = SystemShopArmorMenu.guistate;
	...
	public SystemShopArmorScreen(SystemShopArmorMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = ResourceLocation.parse("slsb:textures/screens/system_shop_armor.png");
	...
	public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
		...
		if (mouseX > leftPos + -69 && mouseX < leftPos + -51 && mouseY > topPos + -37 && mouseY < topPos + -19)
			guiGraphics.renderTooltip(font, Component.translatable("gui.slsb.system_shop_armor.tooltip_erank_helmet"), mouseX, mouseY);
		if (mouseX > leftPos + -69 && mouseX < leftPos + -51 && mouseY > topPos + -14 && mouseY < topPos + 4)
			guiGraphics.renderTooltip(font, Component.translatable("gui.slsb.system_shop_armor.tooltip_erank_chestplate"), mouseX, mouseY);
		if (mouseX > leftPos + -69 && mouseX < leftPos + -51 && mouseY > topPos + 9 && mouseY < topPos + 27)
			guiGraphics.renderTooltip(font, Component.translatable("gui.slsb.system_shop_armor.tooltip_erank_leggings"), mouseX, mouseY);
		if (mouseX > leftPos + -69 && mouseX < leftPos + -51 && mouseY > topPos + 32 && mouseY < topPos + 50)
			guiGraphics.renderTooltip(font, Component.translatable("gui.slsb.system_shop_armor.tooltip_erank_boots"), mouseX, mouseY);
		if (mouseX > leftPos + 3 && mouseX < leftPos + 21 && mouseY > topPos + -37 && mouseY < topPos + -19)
			guiGraphics.renderTooltip(font, Component.translatable("gui.slsb.system_shop_armor.tooltip_drank_helmet"), mouseX, mouseY);
		if (mouseX > leftPos + 3 && mouseX < leftPos + 21 && mouseY > topPos + -14 && mouseY < topPos + 4)
			guiGraphics.renderTooltip(font, Component.translatable("gui.slsb.system_shop_armor.tooltip_drank_chestplate"), mouseX, mouseY);
		if (mouseX > leftPos + 3 && mouseX < leftPos + 21 && mouseY > topPos + 9 && mouseY < topPos + 27)
			guiGraphics.renderTooltip(font, Component.translatable("gui.slsb.system_shop_armor.tooltip_drank_leggings"), mouseX, mouseY);
		if (mouseX > leftPos + 3 && mouseX < leftPos + 21 && mouseY > topPos + 32 && mouseY < topPos + 50)
			guiGraphics.renderTooltip(font, Component.translatable("gui.slsb.system_shop_armor.tooltip_drank_boots"), mouseX, mouseY);
		if (mouseX > leftPos + -72 && mouseX < leftPos + -63 && mouseY > topPos + -52 && mouseY < topPos + -43)
			guiGraphics.renderTooltip(font, Component.translatable("gui.slsb.system_shop_armor.tooltip_back"), mouseX, mouseY);
		if (mouseX > leftPos + -60 && mouseX < leftPos + -42 && mouseY > topPos + 86 && mouseY < topPos + 104)
			guiGraphics.renderTooltip(font, Component.translatable("gui.slsb.system_shop_armor.tooltip_fighter"), mouseX, mouseY);
		if (mouseX > leftPos + -40 && mouseX < leftPos + -22 && mouseY > topPos + 86 && mouseY < topPos + 104)
			guiGraphics.renderTooltip(font, Component.translatable("gui.slsb.system_shop_armor.tooltip_tanker"), mouseX, mouseY);
		if (mouseX > leftPos + -20 && mouseX < leftPos + -2 && mouseY > topPos + 86 && mouseY < topPos + 104)
			guiGraphics.renderTooltip(font, Component.translatable("gui.slsb.system_shop_armor.tooltip_assassin"), mouseX, mouseY);
		if (mouseX > leftPos + 0 && mouseX < leftPos + 18 && mouseY > topPos + 86 && mouseY < topPos + 104)
			guiGraphics.renderTooltip(font, Component.translatable("gui.slsb.system_shop_armor.tooltip_ranger"), mouseX, mouseY);
		if (mouseX > leftPos + 20 && mouseX < leftPos + 38 && mouseY > topPos + 86 && mouseY < topPos + 104)
			guiGraphics.renderTooltip(font, Component.translatable("gui.slsb.system_shop_armor.tooltip_mage"), mouseX, mouseY);
		if (mouseX > leftPos + 40 && mouseX < leftPos + 58 && mouseY > topPos + 86 && mouseY < topPos + 104)
			guiGraphics.renderTooltip(font, Component.translatable("gui.slsb.system_shop_armor.tooltip_healer"), mouseX, mouseY);
	}
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		...
		guiGraphics.drawString(this.font, Component.translatable("gui.slsb.system_shop_armor.label_10k"), -47, -31, -15657947, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.slsb.system_shop_armor.label_10k1"), -47, -8, -15657947, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.slsb.system_shop_armor.label_10k2"), -47, 15, -15657947, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.slsb.system_shop_armor.label_10k3"), -47, 38, -15657947, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.slsb.system_shop_armor.label_10k4"), -48, -32, -1, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.slsb.system_shop_armor.label_10k5"), -48, -9, -1, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.slsb.system_shop_armor.label_10k6"), -48, 14, -1, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.slsb.system_shop_armor.label_10k7"), -48, 37, -1, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.slsb.system_shop_armor.label_100k"), 25, -31, -15657947, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.slsb.system_shop_armor.label_100k1"), 25, -8, -15657947, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.slsb.system_shop_armor.label_100k2"), 25, 15, -15657947, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.slsb.system_shop_armor.label_100k3"), 25, 38, -15657947, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.slsb.system_shop_armor.label_100k4"), 24, -32, -1, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.slsb.system_shop_armor.label_100k5"), 24, -9, -1, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.slsb.system_shop_armor.label_100k6"), 24, 14, -1, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.slsb.system_shop_armor.label_100k7"), 24, 37, -1, false);
	}

	@Override
	public void init() {
		super.init();
		button_ssfsslx = new PlainTextButton(this.leftPos + -72, this.topPos + -52, 51, 20, Component.translatable("gui.slsb.system_shop_armor.button_ssfsslx"), e -> {
			if (true) {
				PacketDistributor.sendToServer(new SystemShopArmorButtonMessage(0, x, y, z));
				SystemShopArmorButtonMessage.handleButtonAction(entity, 0, x, y, z);
			}
		}, this.font);
		...
		imagebutton_tab_top = new ImageButton(this.leftPos + -89, this.topPos + -109, 26, 32, new WidgetSprites(ResourceLocation.parse("slsb:textures/screens/tab_top.png"), ResourceLocation.parse("slsb:textures/screens/tab_top.png")), e -> {
			if (true) {
				PacketDistributor.sendToServer(new SystemShopArmorButtonMessage(1, x, y, z));
				SystemShopArmorButtonMessage.handleButtonAction(entity, 1, x, y, z);
			}
		}) {
			@Override
		...
		imagebutton_tab_top2 = new ImageButton(this.leftPos + -64, this.topPos + -109, 26, 32, new WidgetSprites(ResourceLocation.parse("slsb:textures/screens/tab_top.png"), ResourceLocation.parse("slsb:textures/screens/tab_top.png")), e -> {
			if (true) {
				PacketDistributor.sendToServer(new SystemShopArmorButtonMessage(2, x, y, z));
				SystemShopArmorButtonMessage.handleButtonAction(entity, 2, x, y, z);
			}
		}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int x, int y, float partialTicks) {
		...
		imagebutton_tab_top1 = new ImageButton(this.leftPos + -14, this.topPos + -109, 26, 32, new WidgetSprites(ResourceLocation.parse("slsb:textures/screens/tab_top.png"), ResourceLocation.parse("slsb:textures/screens/tab_top.png")), e -> {
			if (true) {
				PacketDistributor.sendToServer(new SystemShopArmorButtonMessage(3, x, y, z));
				SystemShopArmorButtonMessage.handleButtonAction(entity, 3, x, y, z);
			}
		}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int x, int y, float partialTicks) {
		...
		imagebutton_system_arrow_right = new ImageButton(this.leftPos + 82, this.topPos + -1, 16, 16,
				new WidgetSprites(ResourceLocation.parse("slsb:textures/screens/system_arrow_right.png"), ResourceLocation.parse("slsb:textures/screens/system_arrow_right.png")), e -> {
					if (true) {
						PacketDistributor.sendToServer(new SystemShopArmorButtonMessage(4, x, y, z));
						SystemShopArmorButtonMessage.handleButtonAction(entity, 4, x, y, z);
					}
				}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int x, int y, float partialTicks) {
		...
		imagebutton_system_arrow_left = new ImageButton(this.leftPos + -100, this.topPos + -1, 16, 16,
				new WidgetSprites(ResourceLocation.parse("slsb:textures/screens/system_arrow_left.png"), ResourceLocation.parse("slsb:textures/screens/system_arrow_left.png")), e -> {
					if (true) {
						PacketDistributor.sendToServer(new SystemShopArmorButtonMessage(5, x, y, z));
						SystemShopArmorButtonMessage.handleButtonAction(entity, 5, x, y, z);
					}
				}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int x, int y, float partialTicks) {
		...
		imagebutton_icon_class_fighter = new ImageButton(this.leftPos + -59, this.topPos + 87, 16, 16,
				new WidgetSprites(ResourceLocation.parse("slsb:textures/screens/icon_class_fighter.png"), ResourceLocation.parse("slsb:textures/screens/icon_class_fighter.png")), e -> {
					if (true) {
						PacketDistributor.sendToServer(new SystemShopArmorButtonMessage(14, x, y, z));
						SystemShopArmorButtonMessage.handleButtonAction(entity, 14, x, y, z);
					}
				}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int x, int y, float partialTicks) {
		...
		imagebutton_icon_class_tanker = new ImageButton(this.leftPos + -39, this.topPos + 87, 16, 16,
				new WidgetSprites(ResourceLocation.parse("slsb:textures/screens/icon_class_tanker.png"), ResourceLocation.parse("slsb:textures/screens/icon_class_tanker.png")), e -> {
					if (true) {
						PacketDistributor.sendToServer(new SystemShopArmorButtonMessage(15, x, y, z));
						SystemShopArmorButtonMessage.handleButtonAction(entity, 15, x, y, z);
					}
				}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int x, int y, float partialTicks) {
		...
		imagebutton_icon_class_assassin = new ImageButton(this.leftPos + -19, this.topPos + 87, 16, 16,
				new WidgetSprites(ResourceLocation.parse("slsb:textures/screens/icon_class_assassin.png"), ResourceLocation.parse("slsb:textures/screens/icon_class_assassin.png")), e -> {
					if (true) {
						PacketDistributor.sendToServer(new SystemShopArmorButtonMessage(16, x, y, z));
						SystemShopArmorButtonMessage.handleButtonAction(entity, 16, x, y, z);
					}
				}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int x, int y, float partialTicks) {
		...
		imagebutton_icon_class_ranger = new ImageButton(this.leftPos + 1, this.topPos + 87, 16, 16,
				new WidgetSprites(ResourceLocation.parse("slsb:textures/screens/icon_class_ranger.png"), ResourceLocation.parse("slsb:textures/screens/icon_class_ranger.png")), e -> {
					if (true) {
						PacketDistributor.sendToServer(new SystemShopArmorButtonMessage(17, x, y, z));
						SystemShopArmorButtonMessage.handleButtonAction(entity, 17, x, y, z);
					}
				}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int x, int y, float partialTicks) {
		...
		imagebutton_icon_class_mage = new ImageButton(this.leftPos + 21, this.topPos + 87, 16, 16,
				new WidgetSprites(ResourceLocation.parse("slsb:textures/screens/icon_class_mage.png"), ResourceLocation.parse("slsb:textures/screens/icon_class_mage.png")), e -> {
					if (true) {
						PacketDistributor.sendToServer(new SystemShopArmorButtonMessage(18, x, y, z));
						SystemShopArmorButtonMessage.handleButtonAction(entity, 18, x, y, z);
					}
				}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int x, int y, float partialTicks) {
		...
		imagebutton_icon_class_healer = new ImageButton(this.leftPos + 41, this.topPos + 87, 16, 16,
				new WidgetSprites(ResourceLocation.parse("slsb:textures/screens/icon_class_healer.png"), ResourceLocation.parse("slsb:textures/screens/icon_class_healer.png")), e -> {
					if (true) {
						PacketDistributor.sendToServer(new SystemShopArmorButtonMessage(19, x, y, z));
						SystemShopArmorButtonMessage.handleButtonAction(entity, 19, x, y, z);
					}
				}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int x, int y, float partialTicks) {
