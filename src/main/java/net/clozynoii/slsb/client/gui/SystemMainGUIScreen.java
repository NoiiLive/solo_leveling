...
public class SystemMainGUIScreen extends AbstractContainerScreen<SystemMainGUIMenu> {
	...
	public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
		...
		if (mouseX > leftPos + -72 && mouseX < leftPos + -13 && mouseY > topPos + -51 && mouseY < topPos + -41)
			guiGraphics.renderTooltip(font, Component.literal(
					...
					ReturnSystemEXPProcedure.execute()), mouseX, mouseY);
	}
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int gx, int gy) {
		...
		guiGraphics.blit(ResourceLocation.parse("slsb:textures/screens/system_bar.png"), this.leftPos + -61, this.topPos + -6, Mth.clamp((int)

		ReturnHealthAmountProcedure.execute(entity) * 86, 0, 946), 0, 86, 10, 1032, 10);

		guiGraphics.blit(ResourceLocation.parse("slsb:textures/screens/system_bar.png"), this.leftPos + -61, this.topPos + 5, Mth.clamp((int)

		ReturnManaAmountProcedure.execute(entity) * 86, 0, 946), 0, 86, 10, 1032, 10);
	...
	public void init() {
		...
		imagebutton_system_stat_button = new ImageButton(this.leftPos + -14, this.topPos + 25, 12, 12,
			...
			public void renderWidget(GuiGraphics guiGraphics, int x, int y, float partialTicks) {
				...
				ReturnSystemHasPointsProcedure.execute(entity)
