...
import net.clozynoii.slsb.network.HunterSkillGUIMageFireButtonMessage;

import java.util.HashMap;

import com.mojang.blaze3d.systems.RenderSystem;

public class HunterSkillGUIMageFireScreen extends AbstractContainerScreen<HunterSkillGUIMageFireMenu> {
	private final static HashMap<String, Object> guistate = HunterSkillGUIMageFireMenu.guistate;
	...
	public HunterSkillGUIMageFireScreen(HunterSkillGUIMageFireMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = ResourceLocation.parse("slsb:textures/screens/hunter_skill_gui_mage_fire.png");
	...
	public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
		...
		if (mouseX > leftPos + 69 && mouseX < leftPos + 87 && mouseY > topPos + -46 && mouseY < topPos + -28)
			guiGraphics.renderTooltip(font, Component.translatable("gui.slsb.hunter_skill_gui_mage_fire.tooltip_slot_1"), mouseX, mouseY);
		if (mouseX > leftPos + 69 && mouseX < leftPos + 87 && mouseY > topPos + -25 && mouseY < topPos + -7)
			guiGraphics.renderTooltip(font, Component.translatable("gui.slsb.hunter_skill_gui_mage_fire.tooltip_slot_2"), mouseX, mouseY);
		if (mouseX > leftPos + 69 && mouseX < leftPos + 87 && mouseY > topPos + -4 && mouseY < topPos + 14)
			guiGraphics.renderTooltip(font, Component.translatable("gui.slsb.hunter_skill_gui_mage_fire.tooltip_slot_3"), mouseX, mouseY);
		if (mouseX > leftPos + 69 && mouseX < leftPos + 87 && mouseY > topPos + 17 && mouseY < topPos + 35)
			guiGraphics.renderTooltip(font, Component.translatable("gui.slsb.hunter_skill_gui_mage_fire.tooltip_slot_4"), mouseX, mouseY);
		if (mouseX > leftPos + 69 && mouseX < leftPos + 87 && mouseY > topPos + 38 && mouseY < topPos + 56)
			guiGraphics.renderTooltip(font, Component.translatable("gui.slsb.hunter_skill_gui_mage_fire.tooltip_slot_5"), mouseX, mouseY);
		if (mouseX > leftPos + 90 && mouseX < leftPos + 108 && mouseY > topPos + -35 && mouseY < topPos + -17)
			guiGraphics.renderTooltip(font, Component.translatable("gui.slsb.hunter_skill_gui_mage_fire.tooltip_slot_6"), mouseX, mouseY);
		if (mouseX > leftPos + 90 && mouseX < leftPos + 108 && mouseY > topPos + -14 && mouseY < topPos + 4)
			guiGraphics.renderTooltip(font, Component.translatable("gui.slsb.hunter_skill_gui_mage_fire.tooltip_slot_7"), mouseX, mouseY);
		if (mouseX > leftPos + 90 && mouseX < leftPos + 108 && mouseY > topPos + 7 && mouseY < topPos + 25)
			guiGraphics.renderTooltip(font, Component.translatable("gui.slsb.hunter_skill_gui_mage_fire.tooltip_slot_8"), mouseX, mouseY);
		if (mouseX > leftPos + 90 && mouseX < leftPos + 108 && mouseY > topPos + 28 && mouseY < topPos + 46)
			guiGraphics.renderTooltip(font, Component.translatable("gui.slsb.hunter_skill_gui_mage_fire.tooltip_slot_9"), mouseX, mouseY);
		if (mouseX > leftPos + 90 && mouseX < leftPos + 108 && mouseY > topPos + 49 && mouseY < topPos + 67)
			guiGraphics.renderTooltip(font, Component.translatable("gui.slsb.hunter_skill_gui_mage_fire.tooltip_slot_10"), mouseX, mouseY);
	...
	public void init() {
		...
		imagebutton_tab_top = new ImageButton(this.leftPos + -63, this.topPos + -107, 26, 32, new WidgetSprites(ResourceLocation.parse("slsb:textures/screens/tab_top.png"), ResourceLocation.parse("slsb:textures/screens/tab_top.png")), e -> {
			if (true) {
				PacketDistributor.sendToServer(new HunterSkillGUIMageFireButtonMessage(0, x, y, z));
				HunterSkillGUIMageFireButtonMessage.handleButtonAction(entity, 0, x, y, z);
			}
		}) {
			@Override
		...
		imagebutton_blank16x = new ImageButton(this.leftPos + 70, this.topPos + -45, 16, 16, new WidgetSprites(ResourceLocation.parse("slsb:textures/screens/blank16x.png"), ResourceLocation.parse("slsb:textures/screens/blank16x.png")), e -> {
			if (true) {
				PacketDistributor.sendToServer(new HunterSkillGUIMageFireButtonMessage(1, x, y, z));
				HunterSkillGUIMageFireButtonMessage.handleButtonAction(entity, 1, x, y, z);
			}
		}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int x, int y, float partialTicks) {
		...
		imagebutton_blank16x1 = new ImageButton(this.leftPos + 70, this.topPos + -24, 16, 16, new WidgetSprites(ResourceLocation.parse("slsb:textures/screens/blank16x.png"), ResourceLocation.parse("slsb:textures/screens/blank16x.png")), e -> {
			if (true) {
				PacketDistributor.sendToServer(new HunterSkillGUIMageFireButtonMessage(2, x, y, z));
				HunterSkillGUIMageFireButtonMessage.handleButtonAction(entity, 2, x, y, z);
			}
		}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int x, int y, float partialTicks) {
		...
		imagebutton_blank16x2 = new ImageButton(this.leftPos + 70, this.topPos + -3, 16, 16, new WidgetSprites(ResourceLocation.parse("slsb:textures/screens/blank16x.png"), ResourceLocation.parse("slsb:textures/screens/blank16x.png")), e -> {
			if (true) {
				PacketDistributor.sendToServer(new HunterSkillGUIMageFireButtonMessage(3, x, y, z));
				HunterSkillGUIMageFireButtonMessage.handleButtonAction(entity, 3, x, y, z);
			}
		}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int x, int y, float partialTicks) {
		...
		imagebutton_blank16x3 = new ImageButton(this.leftPos + 70, this.topPos + 18, 16, 16, new WidgetSprites(ResourceLocation.parse("slsb:textures/screens/blank16x.png"), ResourceLocation.parse("slsb:textures/screens/blank16x.png")), e -> {
			if (true) {
				PacketDistributor.sendToServer(new HunterSkillGUIMageFireButtonMessage(4, x, y, z));
				HunterSkillGUIMageFireButtonMessage.handleButtonAction(entity, 4, x, y, z);
			}
		}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int x, int y, float partialTicks) {
		...
		imagebutton_blank16x4 = new ImageButton(this.leftPos + 70, this.topPos + 39, 16, 16, new WidgetSprites(ResourceLocation.parse("slsb:textures/screens/blank16x.png"), ResourceLocation.parse("slsb:textures/screens/blank16x.png")), e -> {
			if (true) {
				PacketDistributor.sendToServer(new HunterSkillGUIMageFireButtonMessage(5, x, y, z));
				HunterSkillGUIMageFireButtonMessage.handleButtonAction(entity, 5, x, y, z);
			}
		}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int x, int y, float partialTicks) {
		...
		imagebutton_blank16x5 = new ImageButton(this.leftPos + 91, this.topPos + -34, 16, 16, new WidgetSprites(ResourceLocation.parse("slsb:textures/screens/blank16x.png"), ResourceLocation.parse("slsb:textures/screens/blank16x.png")), e -> {
			if (true) {
				PacketDistributor.sendToServer(new HunterSkillGUIMageFireButtonMessage(6, x, y, z));
				HunterSkillGUIMageFireButtonMessage.handleButtonAction(entity, 6, x, y, z);
			}
		}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int x, int y, float partialTicks) {
		...
		imagebutton_blank16x6 = new ImageButton(this.leftPos + 91, this.topPos + -13, 16, 16, new WidgetSprites(ResourceLocation.parse("slsb:textures/screens/blank16x.png"), ResourceLocation.parse("slsb:textures/screens/blank16x.png")), e -> {
			if (true) {
				PacketDistributor.sendToServer(new HunterSkillGUIMageFireButtonMessage(7, x, y, z));
				HunterSkillGUIMageFireButtonMessage.handleButtonAction(entity, 7, x, y, z);
			}
		}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int x, int y, float partialTicks) {
		...
		imagebutton_blank16x7 = new ImageButton(this.leftPos + 91, this.topPos + 8, 16, 16, new WidgetSprites(ResourceLocation.parse("slsb:textures/screens/blank16x.png"), ResourceLocation.parse("slsb:textures/screens/blank16x.png")), e -> {
			if (true) {
				PacketDistributor.sendToServer(new HunterSkillGUIMageFireButtonMessage(8, x, y, z));
				HunterSkillGUIMageFireButtonMessage.handleButtonAction(entity, 8, x, y, z);
			}
		}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int x, int y, float partialTicks) {
		...
		imagebutton_blank16x8 = new ImageButton(this.leftPos + 91, this.topPos + 29, 16, 16, new WidgetSprites(ResourceLocation.parse("slsb:textures/screens/blank16x.png"), ResourceLocation.parse("slsb:textures/screens/blank16x.png")), e -> {
			if (true) {
				PacketDistributor.sendToServer(new HunterSkillGUIMageFireButtonMessage(9, x, y, z));
				HunterSkillGUIMageFireButtonMessage.handleButtonAction(entity, 9, x, y, z);
			}
		}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int x, int y, float partialTicks) {
		...
		imagebutton_blank16x9 = new ImageButton(this.leftPos + 91, this.topPos + 50, 16, 16, new WidgetSprites(ResourceLocation.parse("slsb:textures/screens/blank16x.png"), ResourceLocation.parse("slsb:textures/screens/blank16x.png")), e -> {
			if (true) {
				PacketDistributor.sendToServer(new HunterSkillGUIMageFireButtonMessage(10, x, y, z));
				HunterSkillGUIMageFireButtonMessage.handleButtonAction(entity, 10, x, y, z);
			}
		}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int x, int y, float partialTicks) {
		...
		imagebutton_tab_bottom = new ImageButton(this.leftPos + -63, this.topPos + 78, 26, 32, new WidgetSprites(ResourceLocation.parse("slsb:textures/screens/tab_bottom.png"), ResourceLocation.parse("slsb:textures/screens/tab_bottom.png")), e -> {
			if (true) {
				PacketDistributor.sendToServer(new HunterSkillGUIMageFireButtonMessage(11, x, y, z));
				HunterSkillGUIMageFireButtonMessage.handleButtonAction(entity, 11, x, y, z);
			}
		}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int x, int y, float partialTicks) {
