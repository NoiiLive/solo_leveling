...
@Mod("slsb")
public class SlsbMod {
	public static final Logger LOGGER = LogManager.getLogger(SlsbMod.class);
	public static final String MODID = "slsb";

	public SlsbMod(IEventBus modEventBus) {
